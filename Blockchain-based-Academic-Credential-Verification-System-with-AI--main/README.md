...
1. **Upload** - Student uploads certificate (PDF/Image)
2. **AI Analysis** - Gemini extracts:
   - Recipient name
   - Course/certification name
   - Issuing organization
   - Verification URL
   - Issue date
3. **Name Matching** - Intelligent comparison with student's registered name
4. **URL Verification** - Visits verification URL to cross-check
